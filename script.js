...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Verificar se o dispositivo está online ao carregar a página
    if (navigator.onLine) {
        exportarDadosParaCSV();
    }
});

// Adicionar listener para detectar quando o dispositivo fica online
window.addEventListener('online', exportarDadosParaCSV);
...
function enviarEmailCSV(nomeArquivo, csvContent) {
    const formspreeURL = 'https://formspree.io/f/mpwazkgd'; // Substitua pelo seu endpoint do Formspree
